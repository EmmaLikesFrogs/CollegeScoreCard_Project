...
Initial Data Filtering \# Code for changing NULL values to NA \# Code
for removing bottom rows \# Code for removing columns with less than 70%
completeness \# Code for converting columns to categorical data
...
Categorizing Columns \# categorizing columns Highest degree, Predominant
degree, and \# Carnegie classification columns
...
Filtering Data by State \# function filters out data that does not \#
...
Data Preparation for Bar Plot \# function filters data set to be used in
\# bar_plot function
...
Data Preparation for Grouped Bar Plot \# function filters data set to be
used in \# group_bar_plot function
...
Data Preparation for Ridge Plot \# function filters data set to be used
in \# ridge_plot function
...
Data Preparation for Expense vs. Profit Plot \# function filters data
set to be used in \# exp_vs_profit_plot function
