...
spdf <- geojson_read("/Users/yuhanburgess/Documents/GitHub/DataMungingProject2/test_visualizations/us_states_hexgrid.geojson",  what = "sp")
library(broom)
...
state_count <- read.csv('/Users/yuhanburgess/Documents/GitHub/DataMungingProject2/CollegeScorecard_Raw_Data_08032021/MERGED2021_22_PP.csv')%>%
  count(STABBR)
